      ...
      <header className="sticky top-0 z-40 h-[73px] border-b border-[#9eaec7]/20 bg-[#f4f6ff]/95 backdrop-blur">
        <div className="flex h-full items-center justify-between px-6 md:px-8">
          ...
          <div className="flex items-center gap-2">
            <button className="rounded-full p-2 hover:bg-[#dce9ff]" aria-label="Toggle theme">
              <span className="material-symbols-outlined">light_mode</span>
            </button>
            <button className="relative rounded-full p-2 hover:bg-[#dce9ff]" aria-label="Notifications">
